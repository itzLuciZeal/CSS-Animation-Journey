...
This project is explores the use of **flex box** to organize the information into a **3D animated profile cards** that highlights the person's company name, logo, and the adaptive experience of each.
...
## 🧪 **Technical Challenges & Solutions (Current)**
...
## 🛠️ **Implementation Specs (Current)**
