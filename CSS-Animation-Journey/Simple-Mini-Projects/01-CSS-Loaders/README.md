...
- **Box Shadows**: Realize how useful `box-shadow` is to create cool loading effects by not creating multiple `div` to create dotted loading animation; currently looking forward to improve it.
